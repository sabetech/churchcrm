 ...
 *
 * @method     \ChurchCRM\FamilyQuery|\ChurchCRM\WhyCameQuery|\ChurchCRM\PersonCustomQuery|\ChurchCRM\NoteQuery|\ChurchCRM\Person2group2roleP2g2rQuery|\ChurchCRM\EventAttendQuery|\ChurchCRM\EventQuery|\ChurchCRM\PledgeQuery|\ChurchCRM\UserQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class PersonQuery extends ModelCriteria
{
    ...
    /**
     * Filter the query by a related \ChurchCRM\PersonCustom object
     *
     * @param \ChurchCRM\PersonCustom|ObjectCollection $personCustom the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildPersonQuery The current query, for fluid interface
     */
    ...
    {
        if ($personCustom instanceof \ChurchCRM\PersonCustom) {
            return $this
            ...
            throw new PropelException('filterByPersonCustom() only accepts arguments of type \ChurchCRM\PersonCustom or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \ChurchCRM\PersonCustomQuery A secondary query class using the current class as primary query
     */
    public function usePersonCustomQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'PersonCustom', '\ChurchCRM\PersonCustomQuery');
    }
    ...
    public function filterByPrimaryContactPerson($event, $comparison = null)
    {
        if ($event instanceof \ChurchCRM\Event) {
            ...
            throw new PropelException('filterByPrimaryContactPerson() only accepts arguments of type \ChurchCRM\Event or Collection');
        }
    }
    ...
    public function usePrimaryContactPersonQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'PrimaryContactPerson', '\ChurchCRM\EventQuery');
    }
    ...
    public function filterBySecondaryContactPerson($event, $comparison = null)
    {
        if ($event instanceof \ChurchCRM\Event) {
            ...
            throw new PropelException('filterBySecondaryContactPerson() only accepts arguments of type \ChurchCRM\Event or Collection');
        }
    }
    ...
    public function useSecondaryContactPersonQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'SecondaryContactPerson', '\ChurchCRM\EventQuery');
    }
