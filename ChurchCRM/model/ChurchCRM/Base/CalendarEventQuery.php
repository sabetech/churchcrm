 ...
 *
 * @method     \ChurchCRM\CalendarQuery|\ChurchCRM\EventQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 *
 * @method     ChildCalendarEvent findOneByCalendarId(int $calendar_id) Return the first ChildCalendarEvent filtered by the calendar_id column
 * @method     ChildCalendarEvent findOneByEventId(int $event_id) Return the first ChildCalendarEvent filtered by the event_id column *
...
abstract class CalendarEventQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \ChurchCRM\Base\CalendarEventQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\ChurchCRM\\CalendarEvent', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \ChurchCRM\Calendar object
     *
     * @param \ChurchCRM\Calendar|ObjectCollection $calendar The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($calendar instanceof \ChurchCRM\Calendar) {
            return $this
            ...
            throw new PropelException('filterByCalendar() only accepts arguments of type \ChurchCRM\Calendar or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \ChurchCRM\CalendarQuery A secondary query class using the current class as primary query
     */
    public function useCalendarQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCalendar($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Calendar', '\ChurchCRM\CalendarQuery');
    }
