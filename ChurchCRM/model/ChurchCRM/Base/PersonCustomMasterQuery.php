 ...
 * @method     ChildPersonCustomMaster findOneByFieldSecurity(int $custom_FieldSec) Return the first ChildPersonCustomMaster filtered by the custom_FieldSec column
