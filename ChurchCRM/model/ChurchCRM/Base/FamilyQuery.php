 ...
 *
 * @method     \ChurchCRM\PersonQuery|\ChurchCRM\FamilyCustomQuery|\ChurchCRM\NoteQuery|\ChurchCRM\PledgeQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class FamilyQuery extends ModelCriteria
{
    ...
    /**
     * Filter the query by a related \ChurchCRM\FamilyCustom object
     *
     * @param \ChurchCRM\FamilyCustom|ObjectCollection $familyCustom the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildFamilyQuery The current query, for fluid interface
     */
    ...
    {
        if ($familyCustom instanceof \ChurchCRM\FamilyCustom) {
            return $this
            ...
            throw new PropelException('filterByFamilyCustom() only accepts arguments of type \ChurchCRM\FamilyCustom or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \ChurchCRM\FamilyCustomQuery A secondary query class using the current class as primary query
     */
    public function useFamilyCustomQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'FamilyCustom', '\ChurchCRM\FamilyCustomQuery');
    }
