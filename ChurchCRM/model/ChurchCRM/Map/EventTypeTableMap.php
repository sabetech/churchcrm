...
class EventTypeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'ChurchCRM.Map.EventTypeTableMap';
     ...
     */
    const OM_CLASS = '\\ChurchCRM\\EventType';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'ChurchCRM.EventType';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\ChurchCRM\\EventType');
  ...
  array (
    ...
    1 => ':grp_ID',
        ...
        $this->addRelation('EventType', '\\ChurchCRM\\Event', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':event_type',
    1 => ':type_id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \ChurchCRM\EventType) { // it's a model object
