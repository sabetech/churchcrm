...
class KioskDeviceTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'ChurchCRM.Map.KioskDeviceTableMap';
     ...
     */
    const OM_CLASS = '\\ChurchCRM\\KioskDevice';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'ChurchCRM.KioskDevice';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\ChurchCRM\\KioskDevice');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \ChurchCRM\KioskDevice) { // it's a model object
