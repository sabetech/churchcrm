...
use ChurchCRM\CalendarEvent;
use ChurchCRM\CalendarEventQuery;
...
class CalendarEventTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'ChurchCRM.Map.CalendarEventTableMap';
     ...
     */
    const OM_CLASS = '\\ChurchCRM\\CalendarEvent';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'ChurchCRM.CalendarEvent';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\ChurchCRM\\CalendarEvent');
    ...
    {
        $this->addRelation('Calendar', '\\ChurchCRM\\Calendar', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':calendar_id',
    1 => ':calendar_id',
  ...
  array (
     ...
     * and findPk*() calls.
     *
     * @param \ChurchCRM\CalendarEvent $obj A \ChurchCRM\CalendarEvent object.
     ...
     *
     * @param mixed $value A \ChurchCRM\CalendarEvent object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \ChurchCRM\CalendarEvent) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \ChurchCRM\CalendarEvent object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \ChurchCRM\CalendarEvent) { // it's a model object
