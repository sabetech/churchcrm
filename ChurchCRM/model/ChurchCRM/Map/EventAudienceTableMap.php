...
use ChurchCRM\EventAudience;
use ChurchCRM\EventAudienceQuery;
...
class EventAudienceTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'ChurchCRM.Map.EventAudienceTableMap';
     ...
     */
    const OM_CLASS = '\\ChurchCRM\\EventAudience';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'ChurchCRM.EventAudience';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\ChurchCRM\\EventAudience');
  ...
  array (
     ...
     * and findPk*() calls.
     *
     * @param \ChurchCRM\EventAudience $obj A \ChurchCRM\EventAudience object.
     ...
     *
     * @param mixed $value A \ChurchCRM\EventAudience object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \ChurchCRM\EventAudience) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \ChurchCRM\EventAudience object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \ChurchCRM\EventAudience) { // it's a model object
