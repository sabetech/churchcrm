...
class PersonCustomTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'ChurchCRM.Map.PersonCustomTableMap';
     ...
     */
    const OM_CLASS = '\\ChurchCRM\\PersonCustom';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'ChurchCRM.PersonCustom';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\ChurchCRM\\PersonCustom');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \ChurchCRM\PersonCustom) { // it's a model object
